	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>Special Offers Every Week! Check out today!</p>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Call us on : (+62) 823 1030 4943</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php"><img src="images/Freesia.png"></a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Thank you, <?=$_SESSION['name']?> for buying <?php echo $itungtrans3 ?> item in Freesia</span></h1>
			...
			<hr>
			<br><center>
			<h2>The total price listed above includes postage of Rp10.000</h2>
			<h2>When you have made a payment, please let us know.</h2>
			<br>
		...
		<br>
        <br>
        <p>Your order will be processed immediately 1x24 hours after you make a payment to our bank and include personal information.</p>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Freesia, Mercu Buana, Kota Bekasi.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:kidungaryaa@gmail.com">freesia@florist.ac.id</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 823 1030 4943</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2021 Freesia. All rights reserved</p>
			</div>
		</div>
